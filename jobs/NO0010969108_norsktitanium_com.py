...
class SubPlugin(pluginBase.Plugin):
    ...
    def crawl(self, item):
        try:
            html = fc.fetch(url='https://www.norsktitanium.com/investors')
            ...
            # get the holders
            data_list1 = []
            for idx, tr in enumerate(soup.select(r'div.col-span-3.md\3a col-span-2.p-6.border-r.md\3a border-0.border-\5b \23 b79257\5d > div > div > div.mt-4.w-full > div')):
                if idx == 0:
                    continue
                ...
                data_list1.append({
                    ...
                    'number_of_shares': tds[2].contents[0].strip(),
